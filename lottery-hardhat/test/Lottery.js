...
describe("Lottery", () => {
  ...
  describe("PickWinner", () => {
    ...
    it("PickWinner", async () => {
      ...
      console.log(
        `account1 balance difference: ${account1EthBal_aft.sub(
          account1EthBal_bef
        )}`
      );
      console.log(
        `account1 balance difference: ${
          account1EthBal_aft.sub(account1EthBal_bef) / 10 ** 18
        }`
      );
      console.log(
        `account2 balance difference: ${account2EthBal_aft.sub(
          account2EthBal_bef
        )}`
      );
      console.log(
        `account2 balance difference: ${
          account2EthBal_aft.sub(account2EthBal_bef) / 10 ** 18
        }`
      );
      console.log(
        `account3 balance difference: ${account3EthBal_aft.sub(
          account3EthBal_bef
        )}`
      );
      console.log(
        `account3 balance difference: ${
          account3EthBal_aft.sub(account3EthBal_bef) / 10 ** 18
        }`
      );
      console.log(
        `account4 balance difference: ${account4EthBal_aft.sub(
          account4EthBal_bef
        )}`
      );
      console.log(
        `account4 balance difference: ${
          account4EthBal_aft.sub(account4EthBal_bef) / 10 ** 18
        }`
      );
      console.log(
        `account5 balance difference: ${account5EthBal_aft.sub(
          account5EthBal_bef
        )}`
      );
      console.log(
        `account5 balance difference: ${
          account5EthBal_aft.sub(account5EthBal_bef) / 10 ** 18
        }`
      );
    });
